(ns nl.k3n.compojure-demo.compojure-demo.rest.webapp
  (:require [clojure.tools.logging :as log]
            [com.stuartsierra.component :as component]
            [compojure.api.sweet :refer :all]
            [ring.util.http-response :refer :all]
            [schema.core :as s])
  (:require [nl.k3n.compojure-demo.compojure-demo.models.status :as m-status]
            [nl.k3n.compojure-demo.compojure-demo.rest.status :as status]))
